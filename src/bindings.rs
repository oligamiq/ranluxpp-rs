...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct ranluxpp_t {
    pub x: [u64; 9usize],
    pub A: [u64; 9usize],
}
#[test]
fn bindgen_test_layout_ranluxpp_t() {
    const UNINIT: ::std::mem::MaybeUninit<ranluxpp_t> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<ranluxpp_t>(),
        144usize,
        concat!("Size of: ", stringify!(ranluxpp_t))
    );
    assert_eq!(
        ::std::mem::align_of::<ranluxpp_t>(),
        8usize,
        concat!("Alignment of ", stringify!(ranluxpp_t))
    );
    assert_eq!(
...
extern "C" {
    pub fn ranluxpp_init(r: *mut ranluxpp_t, seed: u64, p: u64);
}
extern "C" {
    pub fn ranluxpp_nextstate(r: *mut ranluxpp_t);
}
extern "C" {
    pub fn ranluxpp_jump(r: *mut ranluxpp_t, n: u64);
}
extern "C" {
    pub fn ranluxpp_fprintf(r: *mut ranluxpp_t, stream: *mut FILE);
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
